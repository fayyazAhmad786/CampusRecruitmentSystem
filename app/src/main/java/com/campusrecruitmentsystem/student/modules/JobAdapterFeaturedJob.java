...
public class JobAdapterFeaturedJob extends RecyclerView.Adapter<JobAdapterFeaturedJob.ViewHolder> {
    private static final float MARGIN_END_LAS_ELEMENT = 0;
    private List<FeaturedJobs> jobList;
    ...
    public JobAdapterFeaturedJob(Context context) {
        this.context = context;
    }

    public void setJobList(List<FeaturedJobs> jobList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_jobs_list_2, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        FeaturedJobs FeaturedJobs = jobList.get(position);
        holder.tv_salery_range.setText(FeaturedJobs.getSalleryRange());
        holder.jobTitleTextView.setText(FeaturedJobs.getJobTitle());
        holder.companyNameTextView.setText(FeaturedJobs.getCompanyName());
        holder.tv_location.setText(FeaturedJobs.getCompanyLocation());
        profilePic = FeaturedJobs.getCompanyProfilePic();
